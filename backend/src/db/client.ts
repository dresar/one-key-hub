  ...
  try {
    ...
    if (modelCount === 0) {
      ...
      const defaultModels = [
        ...
        { provider: 'cohere', model_id: 'command-r-plus-08-2024', display_name: 'Command R+ (08-2024)', is_default: true, supports_vision: false },
        { provider: 'cohere', model_id: 'command-r-08-2024', display_name: 'Command R (08-2024)', is_default: false, supports_vision: false },
        { provider: 'cohere', model_id: 'command-a-plus-05-2026', display_name: 'Command A+ (05-2026)', is_default: false, supports_vision: true },
        { provider: 'cohere', model_id: 'command-a-03-2025', display_name: 'Command A (03-2025)', is_default: false, supports_vision: false },
        { provider: 'cohere', model_id: 'command-a-reasoning-08-2025', display_name: 'Command A Reasoning', is_default: false, supports_vision: false },
        { provider: 'cohere', model_id: 'command-a-translate-08-2025', display_name: 'Command A Translate', is_default: false, supports_vision: false },
        { provider: 'cohere', model_id: 'command-a-vision-07-2025', display_name: 'Command A Vision', is_default: false, supports_vision: true },
        { provider: 'cohere', model_id: 'command-r7b-12-2024', display_name: 'Command R7B', is_default: false, supports_vision: false },
        { provider: 'cohere', model_id: 'command-r7b-arabic-02-2025', display_name: 'Command R7B Arabic', is_default: false, supports_vision: false },
        { provider: 'cohere', model_id: 'c4ai-aya-expanse-32b', display_name: 'Aya Expanse 32B', is_default: false, supports_vision: false },
        { provider: 'cohere', model_id: 'c4ai-aya-vision-32b', display_name: 'Aya Vision 32B', is_default: false, supports_vision: true },
        { provider: 'cohere', model_id: 'north-mini-code-1-0', display_name: 'North Mini Code', is_default: false, supports_vision: false },
        { provider: 'cohere', model_id: 'tiny-aya-earth', display_name: 'Tiny Aya Earth', is_default: false, supports_vision: false },
        { provider: 'cohere', model_id: 'tiny-aya-fire', display_name: 'Tiny Aya Fire', is_default: false, supports_vision: false },
        { provider: 'cohere', model_id: 'tiny-aya-global', display_name: 'Tiny Aya Global', is_default: false, supports_vision: false },
        { provider: 'cohere', model_id: 'tiny-aya-water', display_name: 'Tiny Aya Water', is_default: false, supports_vision: false },
